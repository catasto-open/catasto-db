...
def upgrade() -> None:
    ...
    op.drop_index('idx_quadri_unione_t_pt_ins', table_name='quadri_unione', schema='ctmp_a', postgresql_using='gist')
    op.drop_index('idx_quadri_unione_t_ln_anc', table_name='quadri_unione', schema='ctmp_a', postgresql_using='gist')
    op.drop_index('idx_quadri_unione_geom', table_name='quadri_unione', schema='ctmp_a', postgresql_using='gist')

    op.create_index('quadri_unione_si1', 'quadri_unione', ['geom'], unique=False, schema='ctmp_a',
                    postgresql_using='gist')
    op.create_index('quadri_unione_si2', 'quadri_unione', ['t_pt_ins'], unique=False, schema='ctmp_a',
                    postgresql_using='gist')
    op.create_index('quadri_unione_si3', 'quadri_unione', ['t_ln_anc'], unique=False, schema='ctmp_a',
                    postgresql_using='gist')
...
def downgrade() -> None:
    op.drop_index('quadri_unione_si1', table_name='quadri_unione', schema='ctmp_a', postgresql_using='gist')
    op.drop_index('quadri_unione_si2', table_name='quadri_unione', schema='ctmp_a', postgresql_using='gist')
    op.drop_index('quadri_unione_si3', table_name='quadri_unione', schema='ctmp_a', postgresql_using='gist')
    op.drop_index('quadri_unione_i1', table_name='quadri_unione', schema='ctmp_a', postgresql_using='gist')
