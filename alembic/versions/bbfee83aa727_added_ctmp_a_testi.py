...
def upgrade() -> None:
    ...
    op.drop_index('idx_testi_geom', table_name='testi', schema='ctmp_a', postgresql_using='gist')
    op.create_index('testi_si1', 'testi', ['geom'], schema='ctmp_a', postgresql_using='gist')
    op.create_index('testi_i1', 'testi', ["comune", "sezione", "foglio", "allegato", "sviluppo"],
                    schema='ctmp_a', postgresql_using='btree')


def downgrade() -> None:
    op.drop_index('testi_si1', table_name='testi', schema='ctmp_a', postgresql_using='gist')
    op.drop_index('testi_i1', table_name='testi', schema='ctmp_a', postgresql_using='btree')
