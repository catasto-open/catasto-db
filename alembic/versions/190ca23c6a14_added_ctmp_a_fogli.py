...
def upgrade() -> None:
    ...
    op.drop_index('idx_fogli_t_pt_ins', table_name='fogli', schema='ctmp_a', postgresql_using='gist')
    op.drop_index('idx_fogli_t_ln_anc', table_name='fogli', schema='ctmp_a', postgresql_using='gist')
    op.drop_index('idx_fogli_geom', table_name='fogli', schema='ctmp_a', postgresql_using='gist')
    op.create_index('fogli_i1', 'fogli', ["comune", "sezione", "foglio", "allegato", "sviluppo"],
                    schema='ctmp_a', postgresql_using='btree')
    op.create_index('fogli_si1', 'fogli', ['geom'], schema='ctmp_a', postgresql_using='gist')
    op.create_index('fogli_si2', 'fogli', ['t_pt_ins'], schema='ctmp_a', postgresql_using='gist')
    op.create_index('fogli_si3', 'fogli', ['t_ln_anc'], schema='ctmp_a', postgresql_using='gist')


def downgrade() -> None:
    op.drop_index('fogli_i1', table_name='fogli', schema='ctmp_a', postgresql_using='btree')
    op.drop_index('fogli_si1', table_name='fogli', schema='ctmp_a', postgresql_using='gist')
    op.drop_index('fogli_si2', table_name='fogli', schema='ctmp_a', postgresql_using='gist')
    op.drop_index('fogli_si3', table_name='fogli', schema='ctmp_a', postgresql_using='gist')
