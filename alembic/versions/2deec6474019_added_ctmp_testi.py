...
def upgrade() -> None:
    ...
    op.create_index(
        "testi_si1", "testi", ["geom"], schema="ctmp", postgresql_using="gist"
    )
    op.create_index(
        "testi_i1",
        "testi",
...
def downgrade() -> None:
    op.drop_index(
        "testi_si1", table_name="testi", schema="ctmp", postgresql_using="gist"
    )
    op.drop_index(
        "testi_i1", table_name="testi", schema="ctmp", postgresql_using="btree"
    )
