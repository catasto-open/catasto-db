...
def upgrade() -> None:
    ...
    op.drop_index('idx_raster_geom', table_name='raster', schema='ctmp', postgresql_using='gist')
    op.create_index('raster_si1', 'raster', ['geom'], schema='ctmp', postgresql_using='gist')
    op.create_index('raster_i1', 'raster', ["comune", "sezione", "foglio", "allegato", "sviluppo"],
                    schema='ctmp', postgresql_using='btree')


def downgrade() -> None:
    op.drop_index('raster_i1', table_name='raster', schema='ctmp', postgresql_using='btree')
    op.drop_index('raster_si1', table_name='raster', schema='ctmp', postgresql_using='gist')
