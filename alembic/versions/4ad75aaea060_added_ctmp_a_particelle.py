...
def upgrade() -> None:
    ...
    op.drop_index('idx_particelle_t_pt_ins', table_name='particelle', schema='ctmp_a', postgresql_using='gist')
    op.drop_index('idx_particelle_t_ln_anc', table_name='particelle', schema='ctmp_a', postgresql_using='gist')
    op.drop_index('idx_particelle_geom', table_name='particelle', schema='ctmp_a', postgresql_using='gist')
    ...
    op.create_index('particelle_si1', 'particelle', ['geom'], schema='ctmp_a', postgresql_using='gist')
    op.create_index('particelle_si2', 'particelle', ['t_pt_ins'], schema='ctmp_a',
                    postgresql_using='gist')
    op.create_index('particelle_si3', 'particelle', ['t_ln_anc'], schema='ctmp_a',
                    postgresql_using='gist')


def downgrade() -> None:
    op.drop_index('particelle_i1', table_name='particelle', schema='ctmp_a', postgresql_using='btree')
    op.drop_index('particelle_si1', table_name='particelle', schema='ctmp_a', postgresql_using='gist')
    op.drop_index('particelle_si2', table_name='particelle', schema='ctmp_a', postgresql_using='gist')
    op.drop_index('particelle_si3', table_name='particelle', schema='ctmp_a', postgresql_using='gist')
