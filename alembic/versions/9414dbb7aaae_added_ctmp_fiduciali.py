...
def upgrade() -> None:
    ...
    op.drop_index('idx_fiduciali_geom', table_name='fiduciali', schema='ctmp', postgresql_using='gist')
    op.drop_index('idx_fiduciali_t_pt_ins', table_name='fiduciali', schema='ctmp', postgresql_using='gist')

    op.create_index('fiduciali_si1', 'fiduciali', ['geom'], unique=False, schema='ctmp', postgresql_using='gist')
    op.create_index('fiduciali_si2', 'fiduciali', ['t_pt_ins'], unique=False, schema='ctmp', postgresql_using='gist')
    op.create_index('fiduciali_i1', 'fiduciali', ["comune", "sezione", "foglio", "allegato", "sviluppo"],
                    schema='ctmp', postgresql_using='btree')


def downgrade() -> None:
    op.drop_index('fiduciali_i1', table_name='fiduciali', schema='ctmp', postgresql_using='btree')
    op.drop_index('fiduciali_si1', table_name='fiduciali', schema='ctmp', postgresql_using='gist')
    op.drop_index('fiduciali_si2', table_name='fiduciali', schema='ctmp', postgresql_using='gist')
