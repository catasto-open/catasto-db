...
def upgrade() -> None:
    op.create_table('raster',
                    ...
                    sa.Column('nome_file', sa.String(length=80), nullable=True,
    ...
    op.drop_index('idx_raster_geom', table_name='raster', schema='ctmp_a', postgresql_using='gist')
    op.create_index('raster_si1', 'raster', ['geom'], schema='ctmp_a', postgresql_using='gist')
    op.create_index('raster_i1', 'raster', ["comune", "sezione", "foglio", "allegato", "sviluppo"],
                    schema='ctmp_a', postgresql_using='btree')


def downgrade() -> None:
    op.drop_index('raster_i1', table_name='raster', schema='ctmp_a', postgresql_using='btree')
    op.drop_index('raster_si1', table_name='raster', schema='ctmp_a', postgresql_using='gist')
