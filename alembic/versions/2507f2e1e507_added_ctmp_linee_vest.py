...
def upgrade() -> None:
    ...
    op.drop_index('idx_linee_vest_geom', table_name='linee_vest', schema='ctmp', postgresql_using='gist')
    op.create_index('linee_vest_si1', 'linee_vest', ['geom'], schema='ctmp', postgresql_using='gist')
    op.create_index('linee_vest_i1', 'linee_vest', ["comune", "sezione", "foglio", "allegato", "sviluppo"],
                    schema='ctmp', postgresql_using='btree')


def downgrade() -> None:
    op.drop_index('linee_vest_si1', table_name='linee_vest', schema='ctmp', postgresql_using='gist')
    op.drop_index('linee_vest_i1', table_name='linee_vest', schema='ctmp', postgresql_using='btree')
