...
def upgrade() -> None:
    ...
    op.create_index('cuutilit_idx1', 'cuutilit', ['codice', 'sezione', 'immobile', 'tipo_imm', 'progressiv'],
                    schema='ctcn', postgresql_using='btree')


def downgrade() -> None:
    op.drop_index('cuutilit_idx1', table_name='cuutilit', schema='ctcn', postgresql_using='btree')
