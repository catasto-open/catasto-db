...
def upgrade() -> None:
    op.create_table('ctfisica',
                    ...
                    sa.PrimaryKeyConstraint('codice', 'sezione', 'soggetto', 'tipo_sog', name='ctfisica_pkey'),
                    schema='ctcn'
                    )
    op.create_index('ctfisica_i1', 'ctfisica', [text("cognome varchar_pattern_ops"), text("nome varchar_pattern_ops")],
...
def downgrade() -> None:
    op.drop_index('ctfisica_i1', table_name='ctfisica', schema='ctcn', postgresql_using='btree')
    op.drop_index('ctfisica_i2', table_name='ctfisica', schema='ctcn', postgresql_using='btree')
    op.drop_index('ctfisica_i3', table_name='ctfisica', schema='ctcn', postgresql_using='btree')
    op.drop_index('ctfisica_index01', table_name='ctfisica', schema='ctcn', postgresql_using='btree')
