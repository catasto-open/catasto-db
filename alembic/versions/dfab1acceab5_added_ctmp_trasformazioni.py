...
def upgrade() -> None:
    op.create_table('trasformazioni',
                    ...
                    sa.Column('allegato', sa.String(length=1), nullable=False,
                              comment='Eventuale codice allegato'),
                    sa.Column('sviluppo', sa.String(length=1), nullable=False,
                              comment='Eventuale codice sviluppo'),
                    sa.Column('n_trasf', sa.Integer(), nullable=False,
                              comment='Numero ordinale della trasformazione'),
                    sa.Column('tipo_trasf', sa.String(length=20), nullable=False,
                              comment='Codice del tipo di trasformazione'),
                    sa.Column('punti_contr', sa.Float(), nullable=False,
                              comment='Punti di controllo usati per creare la matrice di trasformazione'),
                    sa.Column('matrice_trasf', sa.Float(), nullable=False,
                              comment='Matrice di trasformazione'),
                    sa.PrimaryKeyConstraint('comune', 'sezione', 'foglio', 'allegato', 'sviluppo', 'n_trasf',
