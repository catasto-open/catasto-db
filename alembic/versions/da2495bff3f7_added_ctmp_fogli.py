...
def upgrade() -> None:
    ...
    op.create_index(
        "fogli_si1", "fogli", ["geom"], schema="ctmp", postgresql_using="gist"
    )
    op.create_index(
        "fogli_si2",
        "fogli",
...
def downgrade() -> None:
    op.drop_index(
        "fogli_i1", table_name="fogli", schema="ctmp", postgresql_using="btree"
    )
    op.drop_index(
        "fogli_si1", table_name="fogli", schema="ctmp", postgresql_using="gist"
    )
    op.drop_index(
        "fogli_si2", table_name="fogli", schema="ctmp", postgresql_using="gist"
    )
    op.drop_index(
        "fogli_si3", table_name="fogli", schema="ctmp", postgresql_using="gist"
    )
