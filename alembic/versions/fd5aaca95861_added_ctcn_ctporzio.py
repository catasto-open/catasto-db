...
def upgrade() -> None:
    ...
    op.create_index('ctporzio_idx1', 'ctporzio', ["codice", "sezione", "immobile", "tipo_imm", "progressiv"],
                    schema='ctcn', postgresql_using='btree')


def downgrade() -> None:
    op.drop_index('ctporzio_idx1', table_name='ctporzio', schema='ctcn', postgresql_using='btree')
