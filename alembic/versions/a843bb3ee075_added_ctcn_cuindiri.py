...
def upgrade() -> None:
    ...
    op.create_index('cuindiri_idx1', 'cuindiri', ['codice', 'sezione', 'immobile', 'tipo_imm', 'progressiv'],
                    schema='ctcn', postgresql_using='btree')


def downgrade() -> None:
    op.drop_index('cuindiri_idx1', table_name='cuindiri', schema='ctcn', postgresql_using='btree')
