...
CREATE INDEX cttitola_idx2 ON ctcn.cttitola USING btree (codice, sezione, immobile, tipo_imm);
CREATE INDEX cttitola_soggetto_idx ON ctcn.cttitola USING btree (soggetto, tipo_sog);